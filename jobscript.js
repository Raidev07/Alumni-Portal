...
const jobs = [
  {
    ...
    benefits: "HMO coverage, performance bonus, paid leaves, hybrid options after probation.",
  ...
  },
  {
    ...
    benefits: "100% remote, equipment stipend, learning and development budget.",
    link: "https://jobstreet.com",
...
document.getElementById('postBtn').addEventListener('click', () => {
  ...
  const newJob = {
    ...
    req:      document.getElementById('f-req').value.trim()      || 'See job description.',
    benefits: document.getElementById('f-benefits').value.trim() || 'To be discussed.',
