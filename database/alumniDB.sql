...
(1, 'test', 'John Jesses Macuana Escalona III', '2023', 'Business', 'uploads/stories/6a0132b45312e_tao (1).png', 'test hello', 'test hello', '2026-05-11 01:36:52', 5),
(2, 'hello', 'Vehniah Perol Samson', '2024', 'Sports', 'uploads/stories/6a013b8d7f46c_bryle.png', 'tadasd', 'adsasdads', '2026-05-11 02:14:37', 1),
(4, 'dasdad', 'Sam Aidan Capalaran Gonzaga', '2024', 'Business', 'uploads/stories/6a013c2c758ef_bryle.png', 'asdads', 'adsada', '2026-05-11 02:17:16', 9);
...
INSERT INTO `backup_codes` (`id`, `user_id`, `code`, `used`, `created_at`) VALUES
(6, 5, '3DB841AF', 1, '2026-05-12 03:03:58'),
(7, 5, '1945072A', 1, '2026-05-12 03:03:58'),
(8, 5, '367DF4E0', 1, '2026-05-12 03:03:58'),
(9, 5, 'A4FA7F6E', 1, '2026-05-12 03:03:58'),
(10, 5, 'FD845197', 0, '2026-05-12 03:03:58');
...
INSERT INTO `recovery_requests` (`id`, `user_id`, `reason`, `status`, `created_at`) VALUES
(1, 5, 'Forgot password - admin recovery request', 'approved', '2026-05-12 05:43:43');
...
--
ALTER TABLE `recovery_requests`
  ADD CONSTRAINT `recovery_requests_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
