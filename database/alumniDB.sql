...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2026 at 07:09 PM
-- Server version: 10.4.32-MariaDB
-- PHP Version: 8.2.12
...
>>>>>>> f0bb40c (Refactor code structure for improved readability and maintainability)
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_AutoVerifyAlumni` AFTER INSERT ON `alumnidetails` 
FOR EACH ROW 
BEGIN
...
-- Dump completed on 2026-05-07 22:47:13
=======
END$$
...
(49, 'users', 9, 'UPDATE', 9, '2026-05-08 07:56:11'),
(50, 'userprofile', 6, 'UPDATE', 9, '2026-05-08 07:56:11'),
(51, 'users', 7, 'UPDATE', 7, '2026-05-08 08:01:44'),
(52, 'userprofile', 5, 'UPDATE', 7, '2026-05-08 08:01:44'),
(53, 'userprofile', 6, 'UPDATE', 9, '2026-05-08 13:26:59'),
(54, 'userprofile', 1, 'UPDATE', 1, '2026-05-08 13:30:05'),
(55, 'userprofile', 1, 'UPDATE', 1, '2026-05-08 13:48:10'),
(56, 'userprofile', 4, 'UPDATE', 5, '2026-05-09 05:30:44');
...
(4, 5, 'John Jesses', 'Escalona', 'III', 'Macuana', '09927756044', '3078 barangay saksakan st. pasig city', '2005-07-07', 'Male', 'avatar_5_1778304644.png', 'HELLO ITS ME KAT BADING'),
(5, 7, 'Mark Venice', 'Samson', 'Sr.', 'Ash', '09927756044', 'tao', '2012-01-31', 'Male', NULL, NULL),
...
(7, 'escalonajj11ictc.bshs2122@gmail.com', '$2y$10$ZURJzfW797KNlpCaYSrp..OHOYAT.p/lPDJsZiZjLPzXoVErXVhBK', 'alumni', 'inactive', '2026-05-01 14:11:29'),
(9, 'samaidangonzaga@gmail.com', '$2y$10$Z88Xl62AX87rmzFzwbIXq.pdD/KrXz9mD6tlEbkisdbJXuBav.zgS', 'alumni', 'active', '2026-05-03 06:07:04');
